...
class selectionResid extends StatefulWidget {
  final TimeOfDay initialTime;
  final void Function(TimeOfDay)? onTimeChanged;
  const selectionResid({Key? key,required this.initialTime,
    this.onTimeChanged,
  }) : super(key: key);

  @override
  State<selectionResid> createState() => _selectionResidState();
}

class _selectionResidState extends State<selectionResid> {
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Residential Cleaning Service', textAlign: TextAlign.center,
                    ...
                    Text('RM 120', textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)
                    ),
                  ],
                ),
